...
export const learnedExams = {
  ...
  "apple-intelligence": {
    ...
    questions: [
      { type: "multiple", match: "אילו מבין המחוות הבאות עוזרות ללקוחות לשלוט ב‐Apple Watch כש", answers: ["הקשה כפולה של אצבע המורה והאגודל כדי לגלול ב'ערמה חכמה' נהדר.", "היפוך מהיר של פרק כף היד כדי לחזור לעיצוב השעון", "הקשה יחידה חדשה של אצבע המורה והאגודל לבחירת וידג'ט ב'ערמה חכמה'"] },
      { type: "multiple", match: "אילו מבין המאפיינים הבאים של watchOS 27 יהיו חדשים עבור הלקו", answers: ["תמיכה בטרום גיל המעבר ובגיל המעבר ביישום 'בריאות'", "גישה מהירה ליישומים שנמצאים בשימוש לעיתים קרובות ברשת היישומים הדינמיים נהדר.", "גישה נוחה לברקודים או לקודי QR עבור כרטיסים או מינויים ב'ערמה חכמה'"] },
  ...
  "בוחן-ניהול-מכשירי-apple-בעבודה": {
    ...
    questions: [
      ...
      { type: "multiple", match: "אילו שאלות עליכם לשאול כדי להבין את צורכי הפריסה של הלקוחות?", answers: ["\"איך אתם מנהלים את מכשירי ה-iPhone שלכם?\"", "\"מה מחלקת ה‐IT צריכה לעשות כדי שהמכשירים יהיו מוכנים לשימוש על ידי המשתמשים?\"", "\"מה העובדים צריכים לעשות כדי להגדיר את המכשירים שלהם?\""] },
      { type: "multiple", match: "כיצד Apple תומכת בארגונים בתהליכי הפריסה ובשירותים הטכנולוגי", answers: ["Apple מספקת תוכנה שעובדת עם שירותי ניהול המכשירים.", "Apple מספקת תמיכה בטלפון ובדוא\"ל לפריסת מערכות ההפעלה שלה.", "Apple מציעה הכשרה בנושא ניהול מכשירים."] },
    ]
  },
